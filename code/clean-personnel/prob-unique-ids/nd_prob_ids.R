# nd_probs_ids.R
# Description: This file runs fastlink() on the ND data (output from nd_clean.R)
...
input_data <- readRDS("input-data/nd-fastlink-pre.rds")
source("code/assign_unique_ids_fun.R")

#input_data <- readRDS("../data/state-employee-data/ND/clean/nd-fastlink-pre.rds")
...
saveRDS(all_dedupe_list, 
        "output-data/nd-fastlink-post.rds")
