# ri_probs_ids.R
# Description: This file runs fastlink() on the RI data (output from ri_clean.R)
...
input_data <- readRDS("input-data/ri-fastlink-pre.rds")
source("code/assign_unique_ids_fun.R")

#input_data <- readRDS("../data/state-employee-data/RI/clean/ri-fastlink-pre.rds")
...
saveRDS(all_dedupe_list, 
        "output-data/ri-fastlink-post.rds")
